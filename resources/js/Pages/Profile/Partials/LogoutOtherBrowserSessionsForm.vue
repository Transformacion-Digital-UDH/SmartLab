    ...
    <ActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
                Si es necesario, puedes cerrar todas tus otras sesiones de navegador en todos tus dispositivos. A continuación, se muestran algunas de tus sesiones recientes; sin embargo, esta lista puede no ser exhaustiva. Si crees que tu cuenta ha sido comprometida, también deberías actualizar tu contraseña.
            </div>
            ...
            <!-- Confirmación para Cerrar Otras Sesiones -->
