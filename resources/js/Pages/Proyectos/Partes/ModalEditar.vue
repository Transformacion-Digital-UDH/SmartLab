<template>
    ...
    >
        <Form layout="vertical" @finish="enviarFormulario" :model="proyecto">
            ...
            >
                <Select
                    v-model:value="proyecto.estado"
                    placeholder="Seleccione un estado"
                >
                    <Select.Option value="Sin iniciar"
                        >Sin iniciar</Select.Option
                    >
            ...
            <!-- Agrupamos Fecha de inicio y Fecha de finalización en una misma fila -->
...
// Inicializamos las opciones de responsables
...
// Inicializamos las opciones de laboratorios
...
// Función para buscar responsables en el select
const buscarResponsable = (input, option) => {
    return option.label.toLowerCase().indexOf(input.toLowerCase()) >= 0;
};

// Función para buscar laboratorios en el select
...
// Actualiza los valores del proyecto al abrir el modal
watch(
    () => props.visible,
    (val) => {
        if (val) {
