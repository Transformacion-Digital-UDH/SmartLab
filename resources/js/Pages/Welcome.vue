...
<template>
    ...
    <div class="font-sans text-white bg-gradient-to-b from-blue-900 to-gray-900">
        ...
        <h1
            class="text-4xl font-bold md:text-5xl font-bold animate-[float_3s_ease-in-out_infinite]"
        >
        ...
        <!-- Contenido principal -->
        <div
            class="flex flex-col items-center gap-4 mt-6 md:flex-row md:justify-center"
        >
        ...
        <!-- Botón -->
        <button
            class="px-6 py-2 mt-10 text-black rounded-lg bg-amber-100 hover:bg-amber-400 animate-pulse"
        >
            Iniciar Proyecto
        </button>
        ...
        <!-- Imagen Superpuesta -->
        <div
            class="absolute right-0 z-0 transform translate-x-1/2 top-2/4 -rotate-12"
        >
            <img
        ...
        <section
            class="flex items-center justify-center h-auto p-5 bg-white md:h-64"
        >
            <div
            class="grid max-w-6xl grid-cols-1 gap-8 text-center text-blue-800 md:grid-cols-4"
            >
                ...
                <div class="md:col-span-2">
                    <div class="overflow-hidden bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-6">
                            ...
                            <h2 class="mb-4 text-2xl font-bold text-gray-800">Laboratorio de Transformación Digital (LTD)</h2>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center bg-white rounded-lg shadow-md">
                        ...
                        <div class="p-4">
                            ...
                            <h3 class="text-sm font-bold text-gray-800">ArquiLab: Diseña, crea, plantea nuevas estructuras</h3>
                        </div>
                    </div>
                    <!-- Tarjeta 3 -->
                    <div class="flex items-center bg-white rounded-lg shadow-md">
        ...
        <section class="flex items-center justify-center py-20 bg-gradient-to-b from-white to-blue-400">
            ...
            <div class="relative overflow-hidden">
                ...
                <div
                    ...
                    :key="index"
                    class="flex-shrink-0 w-full px-4 md:w-1/3"
                >
                    <div class="overflow-hidden bg-white rounded-lg shadow-lg">
        ...
        <!-- Skills Section -->
        <section id="skills" class="relative px-10 py-24 overflow-hidden text-center bg-gradient-to-b from-blue-600 to-blue-900 min-h-svh ">
            ...
            <!-- Imagen Superpuesta -->
            <div
                class="absolute left-0 z-0 pt-20 -ml-48 transform translate-x-1/2 md:ml-0 md:left-0 top-4/4 rotate-12"
            >
                <img
                src="https://via.placeholder.com/600x400"
                alt="Imagen Superpuesta"
